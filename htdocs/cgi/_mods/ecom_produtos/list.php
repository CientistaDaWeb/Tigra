...
<?php
$busca = $con_cliente->executa('SELECT p.id_produto, p.codigo, p.produto, c.categoria FROM produtos AS p, categorias_produtos AS c WHERE c.id_categorias_produto = p.id_categorias_produto');
...
<?php
	...
	?>
		<tr>
            ...
            <td><a href="<?=$url_base?>/cgi/<?=$mod?>/form/<?=$item['id_produto']?>"><img src="_css/_img/btn/btn_editar.png" /></a></td>
            <td><?=$item['codigo']?></td>
            <td><?=$item['produto']?></td>
