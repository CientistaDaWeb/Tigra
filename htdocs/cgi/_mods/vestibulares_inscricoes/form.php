...
if($id)	{
	$pesquisa = new fac_vestibulares_inscricoes();
	$pesquisa->busca($id);
	$id_fac_vestibulares_inscricoe = $pesquisa->id_fac_vestibulares_inscricoe;
    $nome = $pesquisa->nome;
    $sexo = $pesquisa->sexo;
...
<input type="hidden" value="<?=$id_fac_vestibulares_inscricoe?>" name="id_fac_vestibulares_inscricoe" id="id_fac_vestibulares_inscricoe" />
<table id="formulario">
    <tr>
    ...
    <tr>
        ...
        <td><?=$curso1?> - <?=$curso2?> - <?=$curso3?> - <?=$curso4?> - <?=$curso5?></td>
    </tr>
    <tr>
