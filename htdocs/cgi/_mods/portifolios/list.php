...
<?php
	...
	?>
		<tr>
        	<td class="campo_checkbox"><label for="checkbox<?=$item['id_portifolio']?>" id="label<?=$item['id_portifolio']?>"></label><input type="checkbox" class="crirHiddenJS" name="del_item[]" id="checkbox<?=$item['id_portifolio']?>" value="<?=$item['id_portifolio']?>" /></td>
            <td><a href="<?=$url_base?>/cgi/<?=$mod?>/form/<?=$item['id_portifolio']?>"><img src="_css/_img/btn/btn_editar.png" /></a></td>
