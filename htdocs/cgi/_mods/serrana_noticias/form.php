...
<div id="tabs">
    ...
    <div id="tab-noticias">
        <form action="<?=$url_base?>/cgi/<?=$mod?>/action" method="post" enctype="multipart/form-data" id="form_edicao" onsubmit="return ween_validator();">
            ...
            <table id="formulario">
                <tr>
                    <td class="tit_campo">Título da Notícia:</td>
                </tr>
                <tr>
    ...
    <div id="tab-fotos">
        ...
        if(!$id) {
            ...
            ?>
        <form action="<?=$url_base?>/cgi/_mods/serrana_noticias/upload_fotos.php" method="post" id="FFoto" enctype="multipart/form-data">
            <input type="hidden" value="<?=$id_noticia?>" name="id_noticia" id="id_noticia" />
...
<script type="text/javascript">
    var dataFotos = "<?=$url_base?>/cgi/_mods/serrana_noticias/data_fotos.php";
    function pegaImagens(pagina){
        $("#listaImagens").html('Processando...');
        $.post(dataFotos, {'id_noticia': '<?=$id?>','pagina':pagina}, function(data){
    ...
    $(document).ready(function() {
        ...
        $('#FFoto').uploadify({
            ...
            'script' : '<?=$url_base?>/cgi/_mods/serrana_noticias/upload_fotos.php',
