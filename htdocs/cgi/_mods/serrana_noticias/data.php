...
$qry = "SELECT * FROM noticias_fotos WHERE id_noticia =".$id_noticia;
$order = ' ORDER id_noticias_foto DESC';
...
<p class="foto_miniatura"><img
	src="http://www.<?=decripfy($_SESSION['dominio'],"h0s7")?>/_img/noticias/galeria/thumbs/<?=$data['imagem']?>" />
</p>
<p><?= $data['legenda']?></p>
<p style="text-align: center"><a
	onclick="deleta_foto(<?=$data['id_noticias_foto']?>);"
