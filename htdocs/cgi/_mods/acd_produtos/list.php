...
<?php
$query = 'SELECT p.nome_pt, p.id_produto, p.ordem, pc.categoria_pt FROM produtos p, produtos_categorias pc WHERE p.id_produtos_categoria = pc.id_produtos_categoria';
...
<?php
	...
	?>
		<div><span class="vazio">Não foi encontrado nenhum registro.</span></div>
<?php
}
?>
</form>
