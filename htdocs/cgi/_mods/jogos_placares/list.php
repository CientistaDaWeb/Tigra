...
$query = "SELECT j.id_time_casa, j.id_time_fora, j.data,  j.id_jogo, c.sigla, c.ano FROM jogos AS j, campeonatos AS c WHERE j.id_campeonato = c.id_campeonato AND j.conferido = 1";
