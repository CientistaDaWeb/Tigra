...
<?php
$busca = $con_cliente->executa("SELECT o.id_obra, o.nome, oc.categoria, o.ordem
								FROM obras AS o, obras_categorias AS oc
								WHERE o.id_obras_categoria = oc.id_obras_categoria
								GROUP BY o.id_obra");
...
<?php
	...
	?>
		<div><span class="vazio">N&atilde;o foi encontrada nenhuma Obra.</span></div>
<?php
}
?>
</form>
