...
<form action="<?=$url_base?>/cgi/<?=$mod?>/action" method="post" enctype="multipart/form-data" id="form_edicao" onsubmit="return ween_validator()">
    <input type="hidden" value="<?=$id_revestimento?>" name="id_revestimento" id="id_revestimento" />
    <table id="formulario">
        <tr>
            ...
            <td><select class="inpute" name="ids_revestimentos" id="id_revestimentos">
                    ...
                    foreach($categorias AS $categoria) {
                        if(($categoria['id_revestimentos_categoria'] == $id_revestimentos_categoria) && ($categoria['id_revestimentos_subcategoria'] == $id_revestimentos_subcategoria)) {
                            echo '<option value="'.$categoria['id_revestimentos_categoria'].'" selected="selected">'.$categoria['categoria'].'</option>';
                        }else {
                            echo '<option value="'.$categoria['id_revestimentos_categoria'].'">'.$categoria['categoria'].'</option>';
                        }
                    }
                    ?>
                </select></td>
