...
<?php
$busca = $con_cliente->executa("SELECT id_noticia, data, titulo, categoria, texto FROM noticias AS n, noticias_categorias AS c WHERE n.id_noticias_categoria = c.id_noticias_categoria");
