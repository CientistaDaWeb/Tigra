<?php
class produtos{
    var $id_produto, $id_produtos_categoria, $nome, $referencia, $imagem, $descrição, $largura, $altura, $alturaca, $profundidade, $valor, $visibilidade;
