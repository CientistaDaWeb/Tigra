...
<?php
$query = 'SELECT
                p.id_produto, p.produto, p.descricao, p.imagem, p.imagem2, video, pc.categoria, cs.subcategoria
               FROM
                produtos p
               LEFT JOIN
                produtos_categorias pc
               ON
                pc.id_produtos_categoria = p.id_produtos_categoria
               LEFT JOIN
                categorias_subcategorias cs
               ON
                cs.id_categorias_subcategoria = p.id_categorias_subcategoria
