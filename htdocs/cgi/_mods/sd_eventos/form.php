...
<div id="tabs">
    ...
    <div id="tab-fotos">
        ...
        if(!$id) {
            ...
            ?>
        <form action="<?=$url_base?>/cgi/_mods/sd_eventos/upload_fotos.php" method="post" id="FFoto" enctype="multipart/form-data">
            <input type="hidden" value="<?=$id_evento?>" name="id_evento" id="id_evento" />
...
<script type="text/javascript">
    var dataFotos = "<?=$url_base?>/cgi/_mods/sd_eventos/data_fotos.php";
    ...
    $(document).ready(function() {
        ...
        $('#FFoto').uploadify({
            ...
            'script' : '<?=$url_base?>/cgi/_mods/sd_eventos/upload_fotos.php',
