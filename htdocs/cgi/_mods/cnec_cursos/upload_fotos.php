...
if(!empty($_FILES)) {
    foreach($_FILES AS $ARQUIVO) {
        ...
        if ($upload->uploaded) {
            ...
            $pasta = '/home/weentigra/www/images/'.$dominio.'/cursos/galeria';
            ...
            $pasta = '/home/weentigra/www/images/'.$dominio.'/cursos/galeria/thumbs';
            $upload->image_resize = true;
            ...
            $query = 'INSERT INTO cursos_fotos (id_curso, imagem, legenda) VALUES ('.$id_curso.',"'.$imagem.'", "'.substr($imagem,0,-4).'")';
            $con->query($query);
            if ($upload->processed) {
                echo '1';
                $upload->clean();
