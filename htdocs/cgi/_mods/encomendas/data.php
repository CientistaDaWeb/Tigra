...
<table id="lista" class="display" border="0" cellpadding="0" cellspacing="0">
    ...
    ?>
        <tr class="<?=$linhas[$counter%2]?>">
            ...
            <td><a href="/cgi/<?=$modulo?>/form/<?=$data[$id]?>"><img src="/cgi/_css/_img/btn/btn_editar.png" /></a></td>
        <?php
        foreach($campos as $campo){
...
?>
    <div><span class="vazio">N&atilde;o foi encontrado nenhuma encomenda.</span></div>
<?
}
?>
