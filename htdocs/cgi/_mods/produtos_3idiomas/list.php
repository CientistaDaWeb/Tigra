...
<?php
$query = ' SELECT p.id_produto, p.nome_pt, p.ano, pc.categoria_pt
FROM produtos p
INNER JOIN produtos_categorias pc ON p.id_produtos_categoria = pc.id_produtos_categoria
ORDER BY pc.categoria_pt';
