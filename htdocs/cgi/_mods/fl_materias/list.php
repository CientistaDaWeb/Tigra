...
<?php
$busca = $con_cliente->executa("SELECT * FROM materias, materias_categorias, materias_subcategorias, redatores WHERE materias.id_materias_categoria = materias_categorias.id_materias_categoria AND materias.id_materias_subcategoria = materias_subcategorias.id_materias_subcategoria AND redatores.id_redatore = materias.id_redatore AND materias.id_redatore = $_SESSION[id_tg_usuario] AND materias.status != 2 GROUP BY materias.id_materia");
...
<?php
	...
	?>
		<div><span class="vazio">N&atilde;o foi encontrada nenhuma mat&eacute;ria.</span></div>
<?php
}
?>
</form>
