...
$video = str_replace("watch?v=","v/",limpadados($video));
...
if($_FILES['imagem']['size'] > 0){
	...
	$grava = $con->executa("INSERT INTO materias_videos (video, id_materia, titulo, imagem) VALUES ('$video', $id_materia, '$titulo', '$imagem')");
	echo $imagem. " - ".$up->img_db_name;
}
