<?php
class materias{
	public $id_materia, $titulo, $linha_apoio, $texto, $data, $id_materias_categoria, $id_materias_subcategoria, $id_redatore, $status, $imagem, $legenda_foto, $credito_foto, $video_link, $video_tipo;
	...
	public function busca($id){
		...
		$this->video_tipo = $dados['video_tipo'];
	}
